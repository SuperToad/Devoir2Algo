...
typedef struct {
    ...
    XContext func_xid;              /* Pour memoriser une callback */
    XContext dbuf_xid;              /* Pour memoriser un double buffer */
    ...
    LPCTSTR func_prop;              /* Pour memoriser une callback */
    LPCTSTR dbuf_prop;              /* Pour memoriser un double buffer */
    ...
    int mv_x, mv_y;                 /* Coord pour filtrer WM_MOUSEMOVE */
    Window mv_win;                  /* Window pour filtrer WM_MOUSEMOVE */
